...
// график который бы отображал то, как изменяется скорость построения хеш таблицы в зависимости от того как сильно мы ее сжимаем
void experiment1()
{
    std::cout << "exp1 " << std::endl;
    // реальные данные из словаря
...
// график сравнения скорости построения хэш таблицы для подходов 1 2
void experiment2()
{
...
// сравнение скорости поиска для обоих подходов
void experiment3()
{
